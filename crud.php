...
class Crud  {
	...
	public $defaultappcolumn = array(
				...
				public function view() {
					...
					?>
<script
	src="js/i18n/grid.locale-en.js" type="text/javascript"></script>
<script
	src="js/jquery.jqGrid.min.js" type="text/javascript"></script>
<script
	src='js/jquery.ui.timepicker.js'></script>
<script
	src="js/jquery.multiselect.filter.min.js" type="text/javascript"></script>
<script
	src="js/jquery.multiselect.min.js" type="text/javascript"></script>
<link
	rel="stylesheet" type="text/css" href="css/jquery.multiselect.css" />
<link
	rel="stylesheet" type="text/css"
	href="css/jquery.multiselect.filter.css" />

					<?php
					if ($this->geolocation) {
						?>
<script
	type='text/javascript' src='jsc/jquery.autocomplete.js'></script>
<script
...
/*				function search() {
				...
				google.maps.event.addDomListener(window, 'load', initialize);
					...
					?>
<link
	href="css/ui.jqgrid.css" rel="stylesheet" type="text/css" />
					<?php
...
<form id="editform" method="POST" enctype="multipart/form-data"><input
	type="hidden" id="crudid" name="crudid" value="" /> <input
	type="hidden" id="triggerrefresh" name="triggerrefresh" value="" /> <input
	type="hidden" id="crudcmd" name="crudcmd" value="" /> <input
	type="hidden" id="fromrow" name="fromrow" value="" /> <?php
...
<?php
				...
				private function showEditBox($col) {
					if ($col['type'] == "TEXTBOX") {
						...
						} else if ($col['datatype'] == "court") {
							createCourtCombo($col['name'], "", $col['required']);
...
<div class="modal" id="filtersavedialog"><label>Filter name</label> <input
	type="text" id="filtername" name="filtername" size=60 /></div>

<div class="modal" id="filterdialog">
<div id="filterpanel"><?php
...
<form id="filterform" method="POST" enctype="multipart/form-data"
	action="<?php echo $filterformaction; ?>"><input type="hidden"
	id="triggerrefresh" name="triggerrefresh" value="" /> <input
	type="hidden" id="crudcmd" name="crudcmd" value="" /> <input
	type="hidden" id="savefiltername" name="savefiltername" value="" />
<table width='100%' cellpadding=0 cellspacing=4>
<?php
foreach ($this->columns as $col) {
	if ($col['filter']) {
		...
		if ($col['type'] == "TEXTBOX") {
			if ($col['datatype'] == "timestamp" || $col['datatype'] == "datetime") {
				...
				createCourtCombo("filter_" . $col['name']);
				...
				public function filter() {
					...
					foreach ($this->columns as $col) {
						...
						if ($col['filter'] && $filterValue != "") {
							...
							if ($col['type'] == "MULTIDATACOMBO" || $col['type'] == "DATACOMBO" || $col['datatype'] == "user" || $col['datatype'] == "typist" ||$col['datatype'] == "court" ||$col['datatype'] == "contact") {
								if ($filterValue == "0") {
									continue;
								}
							}
...
foreach ($this->applications as $app) {
	...
	if ($okToRun) {
		if ($app['application'] != "") {
			?> <span title="<?php echo $app['tooltip']; ?>"
	id="<?php echo $app['id']; ?>" class="wrapper"><a class='rgap2 link1'
	href="javascript:application('<?php echo $app['application']; ?>')"><em><b><img
	src='<?php echo $app['imageurl']; ?>' /> <?php echo $app['title']; ?></b></em></a></span>
			<?php

		} else {
			?> <span title="<?php echo $app['tooltip']; ?>"
	id="<?php echo $app['id']; ?>" class="wrapper"><a class='rgap2 link1'
	href="javascript:<?php echo $app['script']; ?>()"><em><b><img
	src='<?php echo $app['imageurl']; ?>' /> <?php echo $app['title']; ?></b></em></a></span>
			<?php
		}
	}
...
if ($this->allowFilter) {
	if (isUserAccessPermitted('Filter')) {
		?> <span id="filterbutton" class="wrapper"> <?php
		$memberid = getLoggedOnMemberID();
		$pageid = $_SESSION['pageid'];
...
<?php
		...
		?> <a class='rgap2 link1' href="javascript:filter()"><em><b><img
	src='images/filter.png' /> Filter</b></em></a> </span> <?php
	}
}
?> <?php
if ($this->allowAdd) {
	if (isUserAccessPermitted('AddItem')) {
		?> <span class="wrapper"><a class='rgap2 link1'
	href="javascript:addCrudItem()"><em><b><img src='images/add.png' /> Add</b></em></a></span>
		<?php
	}
}
?> <?php
if ($this->allowView) {
	if (isUserAccessPermitted('ViewItem')) {
		?> <span class="wrapper"><a disabled class='subapp rgap2 link1'
	href="javascript:viewSelectedRow()"><em><b><img src='images/view.png' />
View</b></em></a></span> <?php
	}
}
?> <?php
if ($this->allowEdit) {
	if (isUserAccessPermitted('EditItem')) {
		?> <span class="wrapper"><a disabled class='subapp rgap2 link1'
	href="javascript:editSelectedRow()"><em><b><img src='images/edit.png' />
Edit</b></em></a></span> <?php
	}
}
?> <?php
if ($this->allowRemove) {
	if (isUserAccessPermitted('RemoveItem')) {
		?> <span class="wrapper"><a disabled class='subapp rgap2 link1'
	href="javascript:removeSelectedRow()"><em><b><img
	src='images/delete.png' /> Remove</b></em></a></span> <?php
	}
}
?> <?php
foreach ($this->subapplications as $app) {
	...
	if ($okToRun) {
		if ($app['application'] != "") {
			?> <span title="<?php echo $app['tooltip']; ?>" class="wrapper"><a
	disabled class='subapp rgap2 link1' id="<?php echo $app['id']; ?>"
	href="javascript: subApp('<?php echo $app['application']; ?>', getPK())"><em><b><img
	width=16 height=16 src='<?php echo $app['imageurl']; ?>' /> <?php echo $app['title']; ?></b></em></a></span>
			<?php

		} else {
			?> <span title="<?php echo $app['tooltip']; ?>" class="wrapper"><a
	disabled class='subapp rgap2 link1' id="<?php echo $app['id']; ?>"
	href="javascript: <?php echo $app['script']; ?>(getPK())"><em><b><img
	width=16 height=16 src='<?php echo $app['imageurl']; ?>' /> <?php echo $app['title']; ?></b></em></a></span>
			<?php
		}
	}
...
?> <?php
if (isset($_GET['puri'])) {
	?> <span class="rgap5 wrapper"><a class='rgap2 link1'
	href="javascript:back()"><em><b><img src='images/back2.png' /> Back</b></em></a></span>
						...
						if (data.length > 0) {
							...
							foreach ($this->columns as $col) {
								if ($col['editable']) {
									...
									} else if ($col['type'] == "DATACOMBO" || $col['type'] == "MULTIDATACOMBO" ) {
										echo "$('#editpanel #" . $col['name'] . "').val(node." . $col['name'] . ");\n";
